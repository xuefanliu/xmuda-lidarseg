...
class NuScenesBase(Dataset):
    ...
    # mapper.get_coarse2idx()
    # 即与官方文档中的数据类别的标签对应
    # 但与bin标注文件里的标签不同
    #   这里是coarse标签，bin文件里的是fine标签
    #   需要在preprocess的时候处理一下
    class_names = [
        "ignore",
        "barrier",
        "bicycle",
    ...
    categories = {
        "vehicle": ["bus", "car", "construction_vehicle", "trailer", "truck"],
        "pedestrian": ["pedestrian"],
        "bike": ["bicycle", "motorcycle"],
        "traffic_boundary": ["barrier", "traffic_cone"],
        "backgroung": ["ignore", "driveable_surface", "other_flat", "sidewalk", "terrain", "manmade", "vegetation"]
    }
    ...
    def __init__(self,
        ...
        if merge_classes:
            # label_mapping = [4 3 2 0 0 0 2 1 3 0 0 4 4 4 4 4 4]
            # class_name = ['vehicle', 'pedestrian', 'bike', 'traffic_boundary', 'backgroung']
